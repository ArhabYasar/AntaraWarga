...
.main-konten .navbar .allert{
  ...
  border: 1px solid #000;
  text-align: center;
  margin: -735px 105px 399px 750px;
}
        ...
        <div class="main">
          ...
          <p class="zack">-</p>
              ...
              <div class="item"><a class="sub-btn"><img src="{{ asset('img/atm 1.png') }}"alt="" class="icon">Iuran Warga
                ...
                <div class="sub-menu">
                  <a href="{{ url('/dashboardPetugas/LaporanIuran/{id}') }}" class="sub-item">Laporan Iuran</a>
              ...
              <div class="item"><a class="sub-btn"><img src="{{ asset('img/shield.png') }}"alt="" class="icon"></i>Keamanan
                ...
                <div class="sub-menu">
                <a href="{{ url('/dashboardPetugas/BukuTamu') }}" class="sub-item">Buku Tamu</a>
