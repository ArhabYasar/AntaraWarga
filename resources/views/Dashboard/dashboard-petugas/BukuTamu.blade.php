...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 20:14</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">BUKU TAMU<a href="{{ url('/dashboardPetugas/BukuTamu/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPetugas/BukuTamu') }}" method="get">
                        <input type="text" class="form-control" name="cari" value="{{ Request::get('cari') }}" id="pengarang" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form  action="{{ url('/dashboardPetugas/BukuTamu/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
