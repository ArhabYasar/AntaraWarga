...
.keterangan1  .radio .checkmark1 {
margin-left:  29px;
}
.keterangan1  .radio  .team1{
margin-left:  29px;
}
...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="head">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPetugas/BukuTamu/'.$data->id) }}" method="post">
                @csrf
                @method('PUT')
                    <div class="hunian">
              ...
                </div>
                ...
                <label class="radio">
                    ...
                    value="Menikah" {{ $data->status_kawin == 'Menikah' ? 'checked' : '' }}>
              ...
                </label>
                <label class="radio">
                    ...
                    value="Belum Menikah" {{ $data->status_kawin == 'Belum Menikah' ? 'checked' : '' }}>
              ...
                </label>
                ...
                <label class="radio">
                    <input class="form-check-input" type="radio" name="status_kawin" id="duda"
                    value="Duda" {{ $data->status_kawin == 'Duda' ? 'checked' : '' }}>
              ...
                </label>
                ...
                <label class="radio">
                    <input class="form-check-input" type="radio" name="status_kawin" id="janda"
                    value="Janda" {{ $data->status_kawin == 'Janda' ? 'checked' : '' }}>
              ...
              <div class="hunian2">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="lain_lain" id="lain_lain"rows="3">{{ $data->lain_lain }}</textarea>
                    </div>
                </div>
              ...
              <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $data->usia }}" name="usia" id="usia"autocomplete="off">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Kunjungan Ke</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $data->kunjungan }}" name="kunjungan"id="kunjungan" autocomplete="off">
                    </div>
                </div>
