        ...
        <form action="{{ url('/dashboardPetugas/BukuTamu/'.$data->id) }}" method="post">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $data->usia }}" name="usia" id="usia"
                            autocomplete="off">
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $data->kunjungan }}" name="kunjungan"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="lain_lain" id="lain_lain"
                            rows="3">{{ $data->lain_lain }}</textarea>
                    </div>
                </div>
                <div class="mb-3 row">
