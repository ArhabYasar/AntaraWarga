...
<body>
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="row">
                <div class="pb-3">
                    <form class="d-flex" action="{{ url('/dashboardUMKM/Pasar') }}" method="get">
                    ...
                    <a href="{{ url('/dashboardUMKM/Pasar/create') }}">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#pasarModal{{ $item->id }}">Detail Produk</a>
                            <a href='{{ url("/dashboardUMKM/Pasar/".$item->id."/edit") }}' class="btn btn-outline-warning btn-sm">Edit</a>
                            <form onsubmit="return confirm('Apakah Yakin Anda Ingin Menghapus Data Ini?')" class="d-inline" action="{{ url('/dashboardUMKM/Pasar/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                ...
                <!-- Modal -->
                <div class="modal fade" id="pasarModal{{ $item->id }}" tabindex="-1" aria-labelledby="pasarModal{{ $item->id }}Label" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="pasarModal{{ $item->id }}Label">{{ $item->nama }}</h5>
