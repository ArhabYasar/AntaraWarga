...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        ...
        <form action="{{ url('/dashboardUMKM/Promosi/'.$data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="hunian">
            ...
            <label for="formFile" class="team">MASUKAN GAMBAR MEDIA PROMOSI PRODUK ANDA</p>
            <div class="hadeh">
                <input type="text" class="kids" id="customFile" value="{{ $data->nama }}" name="nama">
            </div>
            </div>
