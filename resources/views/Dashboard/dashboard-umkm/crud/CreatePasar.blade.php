  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">KAMPUNG PASAR</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action="{{ url('/dashboardUMKM/Pasar') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="hunian">
            <label for="formFile" class="team">Nama Usaha</p>
