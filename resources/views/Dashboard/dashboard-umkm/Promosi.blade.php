...
<div class="container">
  ...
  <img src="{{ asset('img/383.png') }}" alt="" class="icon">
                ...
                <p class="Data">MEDIA PROMOSI PRODUK<a href="{{ url('/dashboardUMKM/Promosi/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>
                <div class="filter">
                    <form action="{{ url('/dashboardUMKM/Promosi') }}" method="get">
                ...
                <li>
                    ...
                    <h2>{{ $item->nama }}</h2>
                    <a  href="{{ route('showDetailPromosi', $item->id) }}"  class="truth" >detail |</a>
                    <a  href="{{ url('/dashboardUMKM/Promosi/'. $item->id .'/edit') }}"  class="truth3" >edit |</a>
                    <form action="{{ url('/dashboardUMKM/Promosi/'.$item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
