  ...
  <div class="sidebar">
        <div class="main">
          ...
          <div class="item"><a href="{{ url('/MediaPP') }}" class="sub-btn"><img src="{{ asset('img/mdi_cart-sale.png') }}"alt="" class="icon"></i>Media Promosi Produk
                  ...
                  <div class="item"><a href="{{ url('/MetraView') }}" class="sub-btn"><img src="{{ asset('img/mdi_cart-sale.png') }}"alt="" class="icon"></i>Media Transaksi
                  </a>
                  </div>
    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">MEDIA TRANSAKSI - VIEW<a href="{{ url('/dashboardUMKM/Transaksi/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardUMKM/Transaksi') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->status }}</td>
                        <td>
                            <a href="{{ route('showDetailTransaksi', $item->id) }}" class="btn btn-warning btn-sm">Detail</a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    @endforeach
