                                    ...
                                    <form action='' method='post' class="form-container">
                                        <div class="left-column">
                                            <div class="form-group">
                                                <label for="username" class="team">Username</label>
                                                <input type="text" class="form-control" value="{{ $data->username ?? 'Username Kosong'}}" name='username' id="username" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="email" class="team">Email</label>
                                                <input type="text" class="form-control" value="{{ $data->email ?? 'Email Kosong'}}" name='email' id="email" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="phone" class="team">No. Handphone</label>
                                                <input type="text" class="form-control" value="{{ $data->nomor_hp ?? 'Nomor HP Kosong'}}" name='nomor_hp' id="phone" readonly>
                                            </div>
                                        </div>
                                        <div class="right-column">
                                            <div class="form-group">
                                                <label for="phone2" class="team">NIK</label>
                                                <input type="text" class="form-control" name='nik' value="{{ $data->nik ?? 'NIK Kosong' }}" id="phone2" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="phone3" class="team">No KK</label>
                                                <input type="text" class="form-control" name='nkk' value="{{ $data->nkk ?? 'Nomor KK Kosong' }}" id="phone3" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="phone4" class="team">Alamat</label>
                                                <input type="text" class="form-control" name='phone4' value="{{ $data->alamat ?? 'Alamat Kosong' }}" id="phone4" readonly>
                                            </div>
                                        </div>
                                    </form>
                                </div>
