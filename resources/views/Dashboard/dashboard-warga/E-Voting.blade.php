    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">E-VOTING</p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/E-Voting') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->judul }}</td>
                        <td>
                            <a href="{{ route('evoting.view', $item->id) }}">
                                <button id="openModal" class="btn btn-warning btn-sm">VIEW</button>
                            </a>
                        </td>
                    </tr>
                    <?php $i++ ?>
...
const cancelButton = document.getElementById("cancelButton"); // Perbarui id tombol menjadi "cancelButton"
...
cancelButton.addEventListener("click", () => { // Perbarui nama event listener
...
votingForm.addEventListener("submit", (e) => {
    ...
    if (selectedOption) {
        alert(`Anda memilih: ${selectedOption.value}`);
        modal.style.display = "none";
        // Kirim data vote ke server di sini (dapat menggunakan AJAX atau API)
    } else {
        alert("Pilih salah satu opsi sebelum mengirim suara.");
    }
});
