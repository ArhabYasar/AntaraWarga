    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">REKENING BANK<a href="{{ url('/dashboardPengurus/RekeningBank/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/RekeningBank') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $i }}</td>
                        <td>{{ $item->rekening }}</td>
                        @if ($item->getBank) <!-- Periksa apakah hunian tersedia -->
                            <td>{{ $item->getBank->nama }}</td>
                        @else
                            <td>-</td>
                        @endif
                        ...
                        @endif
                        <td>
                            <a href='{{ url('/dashboardPengurus/RekeningBank/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/RekeningBank/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
