...
<div class="tableone">
    <form action="{{ url('/dashboardPengurus/DataBank') }}" method="post">
        @csrf
        <div class="hunian">
                <label for="judul" class="team">Nama Bank</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama' value="{{ old('nama') }}" id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="nama" class="team">Nama Pendek/Singkatan</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='singkatan' value="{{ old('singkatan') }}" id="nama">
                </div>
            </div>
