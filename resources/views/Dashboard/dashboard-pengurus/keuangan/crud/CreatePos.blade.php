  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">POS BIAYA</span>
    <p class="nice">-</p>
    </div>

<div class="tableone">
    <form action="{{ url('/dashboardPengurus/PosBiaya') }}" method="post">
        @csrf
            <div class="hunian">
            ...
            <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" name='keterangan' aria-valuemax="{{old('keterangan')}}" id="pengarang"></textarea>
                    </div>
                </div>
