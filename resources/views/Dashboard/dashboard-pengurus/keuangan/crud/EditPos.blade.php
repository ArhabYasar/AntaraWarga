...
<div class="tableone">
    <form action="{{ url('/dashboardPengurus/PosBiaya/'.$data->id) }}" method="post">
        @csrf
        @method('PUT')
            <div class="hunian">
            ...
            <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" name='keterangan' id="pengarang">{{ $data->keterangan }}</textarea>
                    </div>
                </div>
