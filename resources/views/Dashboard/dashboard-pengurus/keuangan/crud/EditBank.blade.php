...
<div class="container">
        ...
        <div class="main">
          ...
          <div class="item"><a class="sub-btn"><img src="{{ asset('img/home.png') }}"alt="" class="icon"></i>Hunian & Warga
              ...
              <div class="item"><a class="sub-btn"><img src="{{ asset('img/shield.png') }}"alt="" class="icon"></i>Keamanan
                ...
                <div class="sub-menu">
                  <a href="ManajemenUser" class="sub-item">User</a>
                  <a href="Manajemen" class="sub-item">Role</a>
                  </div>
                </div>
  ...
  <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 10:28</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">DATA BANK  </span>
    <p class="nice">-</p>
    </div>

<div class="tableone">
    <form action="{{ url('/dashboardPengurus/DataBank/'.$data->id) }}" method="post">
        @csrf
        @method('PUT')
            <div class="hunian">
            ...
            <div class="hunian">
                <label for="nama" class="team">Nama Pendek/Singkatan</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='singkatan' value="{{ $data->singkatan }}" id="nama">
                </div>
            </div>
