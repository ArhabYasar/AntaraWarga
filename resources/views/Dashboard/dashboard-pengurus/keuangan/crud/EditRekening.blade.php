  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">REKENING BANK</span>
    <p class="nice">-</p>
    </div>

<div class="tableone">
    <form action="/dashboardPengurus/RekeningBank/{{ $data->id }}" method="POST">
        @csrf
        @method('PUT')
            <div class="hunian">
                <label for="judul" class="team">Nama Bank</label>
                <div class="col-sm-10">
                    <select name="bank_id" id="bank_id" class="form-control h-100">
                        @foreach ($bank as $bankItem)
                            <option value="{{ $bankItem->id }}" {{ $data->bank_id == $bankItem->id ? 'selected' : '' }}>
                                {{ $bankItem->nama }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="hunian">
                <label for="nama" class="team">No Rekening</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='rekening' value="{{ $data->rekening }}" id="nama">
                </div>
            </div>
            <div class="hunian">
                <label for="nama" class="team">Pemegang</label>
                <div class="col-sm-10">
