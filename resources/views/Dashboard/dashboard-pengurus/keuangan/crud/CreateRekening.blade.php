...
<div class="tableone">
    <form action="{{ url('/dashboardPengurus/RekeningBank') }}" method="post">
        @csrf
<div class="hunian">
                ...
                <div class="col-sm-10">
                    <select name="bank_id" id="bank_id" class="form-control h-100">
                        ...
                        @foreach ($bank as $bankItem)
                            <option value="{{ $bankItem->id }}">{{ $bankItem->nama }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="hunian">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='rekening' value="{{ old('rekening') }}" id="nama">
                </div>
            </div>
            <div class="hunian">
