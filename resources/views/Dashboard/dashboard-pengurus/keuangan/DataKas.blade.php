    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA KAS<a href="{{ url('/dashboardPengurus/DataKas/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/DataKas') }}" method="get">
                        <input type="search" class="form-control" namname="cari" value="{{ Request::get('cari') }}" id="pengarang" >
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href='{{ url('/dashboardPengurus/DataKas/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/DataKas/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
