...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action='{{ url("/dashboardPengurus/Users/$data->id") }}' method='post'>
            @csrf
            @method('PUT')
        <div class="row">
        <div class="col-md-5">
            <div class="hunian">
                ...
                <input type="text" class="form-control"  value="{{ $data->name }}" name="name" id="judul">
            </div>
            <div class="hunian">
                <label for="nama" class="team">Username</label>
                <input type="text" class="form-control"  value="{{ $data->username }}" name="username" id="pengarang">
            </div>
            <div class="hunian">
                <label for="nama" class="team">Email</label>
                <input type="text" class="form-control"  value="{{ $data->email }}" name="email" id="pengarang">
            </div>
        </div>
    </div>
