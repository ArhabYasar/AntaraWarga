  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">MANAJEMEN USER</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action='{{ url('/dashboardPengurus/Users/') }}' method='post'>
            @csrf
        <div class="row">
        <div class="col-md-5">
            <div class="hunian">
                <label for="judul" class="team">Nama User</label>
                <input type="text" class="form-control" value="{{ old('name') }}" name="name" id="judul" autocomplete="off" required>
            </div>
            <div class="hunian">
                <label for="judul" class="team">Email</label>
                <input type="text" class="form-control" value="{{ old('email') }}" name="email" id="judul" autocomplete="off" required>
            </div>
            <div class="hunian">
                <label for="nama" class="team">Username</label>
                <input type="text" class="form-control" value="{{ old('username') }}" name="username" id="pengarang" autocomplete="off" required>
            </div>
            <div class="hunian">
                <label for="password" class="team">Password</label>
                <input type="password" class="form-control" value="{{ old('password') }}" name="password" id="pengarang" autocomplete="off" required>
            </div>
            <div class="hunian">
                <label for="nama" class="team">Role</label>
                <select class="form-control h-100" name="role" id="role">
