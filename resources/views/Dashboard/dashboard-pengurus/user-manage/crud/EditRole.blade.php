  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">MANAJEMEN ROLE </span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action='{{ url('/dashboardPengurus/Role/'.$data->id) }}' method='post'>
            @csrf
            @method('PUT')
        <div class="row">
        <div class="col-md-5">
            <div class="hunian">
                ...
                <label for="judul" class="team">Username</label>
                <input type="text" class="form-control" value="{{ $data->username }}" name="username" id="judul">
            </div>
            <div class="hunian">
