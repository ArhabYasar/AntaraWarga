    ...
    <div class="main-konten">
        <div class="around">
            <div class="strip" id="liveTime"></div>
                ...
                <p class="Data">MANAJEMEN ROLE</p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url("/dashboardPengurus/Users") }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->role }}</td>
                        <td>
                            <a href='{{ url('/dashboardPengurus/Role/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/Role/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-danger btn-sm" name="submit" type="submit" id="deleteButton" >Hapus</button>
                            </form>
