    ...
    <div class="main-konten">
        <div class="around">
            <div class="strip" id="liveTime"></div>
                ...
                <p class="Data">MANAJEMEN USER<a href="{{ url('/dashboardPengurus/Users/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->role }}</td>
                        <td>
                            <a href="{{ url("/dashboardPengurus/Users/$item->id/edit") }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url("/dashboardPengurus/Users/$item->id") }}" method="post" >
                                @csrf
                                @method('DELETE')
                                <button type="submit" class ="btn btn-danger btn-sm" id="deleteButton">Del</button>
                            </form>
