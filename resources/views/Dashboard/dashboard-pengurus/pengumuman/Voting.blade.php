        ...
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                                  ...
                                  <div class="drop"><a class="sub-btn">
                                    ...
                                    <div class="logout">
                                    <a href="{{ url('/Profile/create') }}" class="tohe">
                                      Logout
                                    </a>
                                    </div>
                ...
                <p class="Data">E-Voting<a href="{{ url('/dashboardPengurus/Voting/create') }}" class="btn btn-primary">Tambah Voting</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/Voting') }}" method="get">
                        <input type="search" class="form-control" name="cari" value="{{ Request::get('cari') }}"  name='pengarang' id="pengarang" >
                        <img src="{{ asset('img/pencarian.svg') }}"alt="" class="icon">
                        <div class="zaki"><a href="" class="btn btn-warning btn-sm">Cari</a></p></div>
                    </form>
                </div>
        <div class="table">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->judul }}</td>
                        <td>
                            <a href='{{ url("/dashboardPengurus/Voting/".$item->id) }}' class="btn btn-warning btn-sm">View</a>
                            <a href='{{ url("/dashboardPengurus/Voting/".$item->id."/edit") }}' class="btn btn-warning btn-sm">Edit</a>
                            <form onsubmit="return confirm('Apakah Yakin Anda Ingin Menghapus Data Ini?')" class="d-inline" action="{{ url('/dashboardPengurus/Voting/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
