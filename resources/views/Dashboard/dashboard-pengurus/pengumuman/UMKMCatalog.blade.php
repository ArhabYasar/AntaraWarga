[14.26, 21/12/2023] Zackkk: <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <styl…
[14.26, 21/12/2023] Zackkk: media transaksi
[15.16, 21/12/2023] Zackkk: <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="container">
  ...
  <img src="{{ asset('img/383.png') }}" alt="" class="icon">
                ...
                <p class="Data">UMKM>CATALOG</p>
                <p class="nice">-</p>
                <div class="filter">
                    <form action="{{ url('/dashboardPengurus/UMKM') }}" method="get">
                ...
                <div class="catalog">
                    ...
                    <div class="item3" onclick="openModal('item4')">
                        <img src="{{ asset('path-to-your-image-directory/'.$umkm->foto) }}" alt="" class="icon">
                        <h2>{{ $umkm->nama }}</h2>
                        <a data-catalog="item4" class="link-opacity-10-hover openModalBtn" data-bs-toggle="modal" data-bs-target="#myModal-item4{{ $umkm->id }}">Detail Produk  ></a>
                        <div id="myModal-item4{{ $umkm->id }}" class="modal" data-catalog="item4">
                            <div class="modal-content">
                                <b class="sow"> Detail Produk </b>
                                <span class="close closeModalBtn" data-catalog="item4">&times;</span>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    openModalBtns.forEach(function (openModalBtn) {
        openModalBtn.addEventListener("click", function () {
            const catalog = openModalBtn.getAttribute('data-catalog');
            const modal = document.getElementById(myModal-${catalog});
    ...
    closeModalBtns.forEach(function (closeModalBtn) {
        closeModalBtn.addEventListener("click", function () {
            const catalog = closeModalBtn.getAttribute('data-catalog');
            const modal = document.getElementById(myModal-${catalog});
