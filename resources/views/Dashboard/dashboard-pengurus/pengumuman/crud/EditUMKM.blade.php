  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">UMKM > ADD</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/UMKM/'.$data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        <div class="hunian">
            <label for="judul" class="team">Katagori Usaha</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='kategori' value="{{ $data->kategori }}" id="nik">
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Nama Usaha</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nama' value="{{ $data->nama }}" id="nama"></input>
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Deskripsi Usaha</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" name='deskripsi' id="nama" value="{{ $data->deskripsi }}"></input>
            </div>
        </div>
        <div class="hunian">
