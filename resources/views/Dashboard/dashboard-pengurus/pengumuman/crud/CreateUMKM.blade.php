...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/UMKM') }}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="hunian">
            <label for="judul" class="team">Katagori Usaha</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='kategori' value="{{ old('kategori') }}"d="nik">
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Nama Usaha</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nama' value="{{ old('nama') }}" id="nama"></input>
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Deskripsi Usaha</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" name='deskripsi' id="nama"></input>
            </div>
        </div>
        <div class="hunian">
