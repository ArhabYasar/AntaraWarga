...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Berita') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="hunian">
            <label for="judul" class="team">Katagori Berita</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='kategori' value="{{old('kategori')}}" id="nik">
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Judul Berita</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='judul' value="{{ old('judul') }}" id="nama"></input>
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Isi Berita</label>
            <div class="col-sm-10">
            <textarea type="text" class="form-control" name='isi' id="nama"></textarea>
            </div>
        </div>
        <div class="hunian">
