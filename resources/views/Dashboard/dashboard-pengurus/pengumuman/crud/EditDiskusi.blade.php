  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">Diskusi</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Diskusi/'.$data->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="hunian">
            <label for="judul" class="team">Topik</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='topik' value="{{ $data->topik }}" id="nik">
            </div>
        </div>
        <div class="hunian">
