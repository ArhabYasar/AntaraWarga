...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 08:10</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">BERITA KAMPUNG<a href="{{ url('/dashboardPengurus/Berita/create') }}" class="btn btn-primary">Tambah Berita</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/Berita') }}" method="get">
                        ...
                        <button id="openModalBtn" data-bs-toggle="modal" data-bs-target="#openModalBtn{{ $item->id }}" class="btn btn-warning btn-sm">Detail</button>
                          <div id="openModalBtn{{ $item->id }}" class="modal">
                            <div class="modal-content">
                              <b class="sow"> {{ $item->judul }}</b>
                              <span class="close" id="closeModalBtn">&times;</span>
                              <img src="{{ asset('path-to-your-image-directory/' . $item->foto) }}" alt="" class="icon" width="200px" height="200px" >
                              <p>{{ $item->isi }}</p>
                            </div>
                          </div>
                            <a href='{{ url("/dashboardPengurus/Berita/".$item->id."/edit") }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/Berita/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
