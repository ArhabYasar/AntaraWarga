...
.curve_chart{
  margin: 20px 20px 40px 1000px;
        ...
        .pencarian .btn-danger {
          font-size: 10px;
          width: 70px;
          height: 25px;
          margin : -200px 10px 10px 900px;
        }
        .around .kanan   {
  width: 29px;
  height: 29px;
...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 11:42
          </h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">UMKM<a href="{{ url('/dashboardPengurus/UMKM/create') }}" class="btn btn-primary">Tambah UMKM</a></p>
                <p class="nice">-</p>
                ...
                <a href="{{ url('/dashboardPengurus/UMKM/show') }}" class="btn btn-danger">Catalog</a>
                </div>
        <div class="table">
            <table>
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->nama }}</td>
                        <td>
                            <a href='{{ url("/dashboardPengurus/UMKM/".$item->id."/edit") }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/UMKM/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
