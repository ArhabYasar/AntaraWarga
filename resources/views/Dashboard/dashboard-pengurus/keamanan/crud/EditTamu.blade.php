...
<div class="tableone">
    <form action="{{ url('/dashboardPengurus/TamuMenginap/'.$data->id) }}" method="post">
        @csrf
        @method('PUT')
                <div class="hunian">
                ...
                <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='nama' value="{{$data->nama}}" id="nik">
                    </div>
                </div>
                <div class="hunian">
                ...
                <div class="hunian">
                    <label for="judul" class="team">Status</label>
                    <div class="col-sm-10">
                ...
                <div class="hunian">
                    <label for="judul" class="team">Keperluan</label>
                    <div class="col-sm-10">
                    <textarea type="text" class="form-control" name='keperluan' id="nama">{{ $data->keperluan }}</textarea>
                    </div>
                </div>
