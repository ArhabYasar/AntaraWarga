  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">RUMAH KOSONG </span>
    <p class="nice">-</p>
    </div>

<div class="tableone">
    @include('komponen.pesan')
    <form action="{{ url('/dashboardPengurus/RumahKosong/'.$data->id) }}" method="post">
        @csrf
        @method('PUT')
            <div class="hunian">
                <label for="judul" class="team">Hunian</label>
                <div class="col-sm-10">
                    <select name="hunian_id" id="hunian_id" class="form-control h-100">
                        @foreach ($hunian as $hunianItem)
                            <option value="{{ $hunianItem->id }}" {{ $data->hunian_id == $hunianItem->id ? 'selected' : '' }}>
                                {{ $hunianItem->alamat }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="hunian">
                <label for="judul" class="team">Pemilik</label>
                <div class="col-sm-10">
            ...
            <div class="hunian">
                <label for="judul" class="team">Tanggal Kosong</label>
                <div class="col-sm-10">
                    <input type="date" value="{{ $data->tanggal }}" class="form-control" name='tanggal' id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="judul" class="team">Keterangan</label>
                <div class="col-sm-10">
                <textarea type="text" class="form-control" name='keterangan' id="nama">{{ $data->keterangan }}</textarea>
                </div>
            </div>
