...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/DataSatpam') }}" method="post">
            @csrf
        <div class="hunian">
        ...
        <div class="hunian">
            ...
            <div class="col-sm-10">
                <select name="warga_id" id="warga_id" class="form-control h-100">
                    ...
                    @foreach ($warga as $wargaItem)
                        <option value="{{ $wargaItem->id }}">{{ $wargaItem->tanggal_lahir }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="hunian">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" value="{{ old('tanggal') }}" name='tanggal' id="nik">
            </div>
        </div>
