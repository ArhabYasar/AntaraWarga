...
<div class="tableone">
    ...
    <form action="{{ url('/dashboardPengurus/RumahKosong') }}" method="post">
        @csrf
            <div class="hunian">
            ...
            <div class="hunian">
                ...
                <div class="col-sm-10">
                    <input type="date" value="{{ old('tanggal') }}" class="form-control" name='tanggal' id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="judul" class="team">Keterangan</label>
                <div class="col-sm-10">
                <textarea type="text" class="form-control" name='keterangan' id="nama">{{ old('keterangan') }}</textarea>
                </div>
            </div>
