  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">DATA SATPAM</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/DataSatpam/'.$data->id) }}" method="post">
            @csrf
            @method('PUT')
        <div class="hunian">
        ...
        <div class="hunian">
            <label for="judul" class="team">Tanggal Lahir</label>
            <div class="col-sm-10">
                <select name="warga_id" id="warga_id" class="form-control h-100">
                    @foreach ($warga as $wargaItem)
                        <option value="{{ $wargaItem->id }}" {{ $data->warga_id == $wargaItem->id ? 'selected' : '' }}>
                            {{ $wargaItem->tanggal_lahir }}
                        </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="hunian">
            <label for="judul" class="team">Alamat</label>
            <div class="col-sm-10">
        ...
        <div class="hunian">
            <label for="judul" class="team">Tanggal Bergabung</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" name='tanggal' value="{{ $data->tanggal }}" id="nik">
            </div>
        </div>
