...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 10:44</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA SATPAM<a href="{{ url('/dashboardPengurus/DataSatpam/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/DataSatpam') }}" method="get">
...
<div id="openModalBtn{{ $item->id }}" class="modal">
  <div class="modal-content">
    <b class="sow"> Detail Data Satpam </b>
    <span class="close" id="closeModalBtn">&times;</span>
    <p> Nama <span class="kick">:</span>{{ $item->getWarga->nama }}<br>
        Tanggal-Lahir <span class="slow">:</span>{{ $item->getWarga->tanggal_lahir }}<br>
        Alamat   <span class="denim">:</span>{{ $item->getHunian->alamat }}<br>
        Tanggal Bergabung <span class="sid">:</span>{{$item->tanggal}}</p>
  </div>
</div>
                            <a href='{{ url('/dashboardPengurus/DataSatpam/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/DataSatpam/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
