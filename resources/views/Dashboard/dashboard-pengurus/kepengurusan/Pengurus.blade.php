    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA PENGURUS<a href="{{ url('/dashboardPengurus/Pengurus/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/Pengurus') }}">
        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $i }}</td>
                        @if ($item->getPeriode) <!-- Periksa apakah hunian tersedia -->
                            <td>{{ $item->getPeriode->periode_awal }}</td>
                            <td>{{ $item->getPeriode->periode_akhir }}</td>
                        @else
                            <td>-</td>
                            <td>-</td>
                        @endif
                        <td>{{ $item->nama }}</td>
                        @if ($item->getJabatan) <!-- Periksa apakah hunian tersedia -->
                            <td>{{ $item->getJabatan->nama }}</td>
                        @else
                            <td>-</td>
                        @endif
                        <td>
                            <a href='{{ url('/dashboardPengurus/Pengurus/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/Pengurus/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
