...
<div class="container">
  ...
  <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 11:35</h1>
    ...
    <div class="head">
        <div class="font">
        <span class="Data">Periode Kepengurusan</span>
        <p class="nice">-</p>
    </div>
        </div>
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/PeriodeKepengurusan/'.$data->id) }}" method="post">
                @csrf
                @method('PUT')
            <div class="hunian">
            <label for="judul" class="team">Periode Awal</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" value="{{ $data->periode_awal }}" name='periode_awal' id="nik">
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Periode Akhir</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" value="{{ $data->periode_akhir }}" name='periode_akhir' id="nama">
            </div>
        </div>
                <div class="simpen">
