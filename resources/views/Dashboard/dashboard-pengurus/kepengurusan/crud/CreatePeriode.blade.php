...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="head">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/PeriodeKepengurusan') }}" method="post">
                @csrf
            <div class="hunian">
            <label for="judul" class="team">Periode Awal</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='periode_awal' value="{{ old('periode_awal') }}" id="nik">
            </div>
        </div>
        <div class="hunian">
            <label for="nama" class="team">Periode Akhir</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='periode_akhir' value="{{ old('periode_akhir') }}" id="nama">
            </div>
        </div>
                <div class="simpen">
