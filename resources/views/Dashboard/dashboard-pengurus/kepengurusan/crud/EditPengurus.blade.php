...
<div class="container">
  ...
  <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 10:45</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">DATA PENGURUS</span>
    <p class="nice">-</p>
    </div>

    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Pengurus/'.$data->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="hunian">
            <label for="judul" class="team">Periode</label>
            <div class="col-sm-10">
                <select name="periode_id" id="periode_id" class="form-control h-100">
                    @foreach ($periode as $periodeItem)
                        <option value="{{ $periodeItem->id }}" {{ $data->periode_id == $periodeItem->id ? 'selected' : '' }}>
                            {{ $periodeItem->periode_akhir }}
                        </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="hunian">
            <label for="nama" class="team">Jabatan</label>
            <div class="col-sm-10">
                <select name="jabatan_id" id="jabatan_id" class="form-control h-100">
                    @foreach ($jabatan as $jabatanItem)
                        <option value="{{ $jabatanItem->id }}" {{ $data->jabatan_id == $jabatanItem->id ? 'selected' : '' }}>
                            {{ $jabatanItem->nama }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="hunian">
            <label for="nama" class="team">Nama Pengurus</label>
            <div class="col-sm-10">
