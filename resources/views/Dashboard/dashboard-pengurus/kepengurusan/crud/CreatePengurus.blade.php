...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Pengurus') }}" method="post">
            @csrf
            <div class="hunian">
            ...
            <div class="col-sm-10">
                <select name="periode_id" id="periode_id" class="form-control h-100">
                    ...
                    @foreach ($periode as $periodeItem)
                        <option value="{{ $periodeItem->id }}">{{ $periodeItem->periode_akhir }}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                <select name="jabatan_id" id="jabatan_id" class="form-control h-100">
                    ...
                    @foreach ($jabatan as $jabatanItem)
                        <option value="{{ $jabatanItem->id }}">{{ $jabatanItem->nama }}</option>
                    @endforeach
                </select>
            </div>
        </div>
