    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA KELUARGA-DETAIL</p>
                <p class="nice">-</p>

                <div class="pencarian">
                <div class="jelas">
                    <p>No. Kartu Keluarga<span class="kick">:</span>{{ $data->nkk }}<br>
                        Hunian <span class="slow">:</span>{{ $data->getHunian->alamat }}<br>
                        Status Hunian<span class="denim">:</span>{{ $data->getHunian->status_kepemilikan }}<br>
                        @foreach ($data->getWarga as $warga)
                        @if ($warga->keluarga_id)
                            Kepala Keluarga<span class="kok">:</span>{{ $warga->nama }}<br>
                        @else
                            <td colspan="2">Data Not Available</td>
                        @endif
                        @endforeach
                        Status<span class="kik">:</span>{{ $data->status }}</p>
