...
<div id="create-modal" class="modal">
  <div class="modal-content">
    <span class="lower">Tambah Anggota Keluarga</span>
      @csrf
      <div class="hunt">
      <label for="nama" class="text">Warga</label>
      ...
      <label for="nama" class="text">Status</label>
      <input type="text" class="form-control" id="nama" name="nama">


    <button id="modal-close" class="shut">Tutup</button>
        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Karina Nurul Wati</td>
                        <td>0890098</td>
                        <td>100m</td>
                        <td>
                        <a href="{{ url('/KeluargaDetil') }}" class="btn btn-warning btn-sm">Detail</a>
                        <button id="editButton" class="btn btn-warning btn-sm">Edit</button>
                        <div id="editModal2" class="modal2">
                          <div class="modal-content">
                          <label class="twenty">Ubah Anggota Keluarga</label>
                          <label for="nama" class="tools">Warga</label>
                            <div class="hunt">
                            <input type="text" class="form-control" id="nama" name="nama">
                            <div class="pencarian">
                            <button type="submit" class="guc" name="submit"><img src="{{ asset('img/pencarian.svg') }}"alt="" class="icon"></button>
                            ...
                            <label for="nama" class="tools">Status</label>
                            <input type="text" class="form-control" id="nama" name="nama">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.0/jquery.min.js"></script>
          ...
          <script>
            ...
            var closeButton = document.getElementById('modal-close2');

            btn.onclick = function() {
                modal2.style.display = 'block';
            };

            closeButton.onclick = function() { // Use the correct variable name
