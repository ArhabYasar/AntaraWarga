    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">KEPEMILIKAN HUNIAN<a href="{{ url('/dashboardPengurus/KepemilikanHunian/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/KepemilikanHunian') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    @else
                        <td>-</td>
                    @endif
                    @if ($item->warga) <!-- Periksa apakah hunian tersedia -->
                        <td>{{ $item->warga->nama }}</td>
                    @else
                        <td>-</td>
                    @endif
                    <td>{{$item->tanggal_kepemilikan}}</td>
                    <td>
                            <a href='{{ url('/dashboardPengurus/KepemilikanHunian/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/KepemilikanHunian/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
