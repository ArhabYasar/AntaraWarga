...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 11:29</h1>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA HUNIAN<a href="{{ url('/dashboardPengurus/DataHunian/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                <form class="d-flex" action="{{ url('/dashboardPengurus/DataHunian') }}" method="get">
            ...
            <table>
                ...
                <?php $i = $data->firstItem() ?>
                    ...
                    <td>{{ $i }}</td>
                        ...
                        <td>
                            <a href='{{ url('/dashboardPengurus/DataHunian/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <button class ="btn btn-danger btn-sm" action="{{ url('/dashboardPengurus/DataHunian/'.$item->id) }}" method="POST">Hapus</button>
