...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="head">
        <div class="font">
        <span class="Data">Data Warga</span>
        <p class="nice">-</p>
        ...
        <div class="tableone">
            ...
            <form action="{{ url('/dashboardPengurus/DataWarga/'.$data->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="hunian">
                    <label for="judul" class="team">NIK</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $data->nik }}" name='nik' id="judul">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Nama</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->nama }}" name='nama' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Tempat Lahir</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->tempat_lahir }}" name='tempat_lahir' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Tanggal Lahir</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" value="{{ $data->tanggal_lahir }}" name='tanggal_lahir' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Pekerjaan</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->pekerjaan }}" name='pekerjaan' id="pengarang">
                    </div>
                </div>
