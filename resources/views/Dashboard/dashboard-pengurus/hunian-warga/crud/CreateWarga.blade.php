        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/DataWarga') }}" method="post">
                ...
                <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ old("nik") }}" name='nik' id="judul">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Nama</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old("nama") }}" name='nama' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Tempat Lahir</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old("tempat_lahir") }}" name='tempat_lahir' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Tanggal Lahir</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" value="{{ old("tanggal_lahir") }}" name='tanggal_lahir' id="pengarang">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Pekerjaan</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old("pekerjaan") }}" name='pekerjaan' id="pengarang">
                    </div>
                </div>
