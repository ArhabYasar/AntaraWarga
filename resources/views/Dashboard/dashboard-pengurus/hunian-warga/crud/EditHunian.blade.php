...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="head">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/DataHunian/'.$data->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="hunian">
                ...
                <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->tipe }}" name='tipe' id="tipe">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Luas Tanah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->luas_tanah }}" name='luas_tanah' id="luas_tanah">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Luas Tanah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $data->luas_bangunan }}" name='luas_bangunan' id="luas_bangunan">
                    </div>
                </div>
                <div class="hunian">
                ...
                <label class="radio">
                <input type="radio" name="status_kepemilikan" id="milik_sendiri" value="Milik Sendiri" {{ $data->status_kepemilikan == 'Milik Sendiri' ? 'checked' : '' }}>
                Milik Sendiri
                <span class="checkmark"></span>
                </label>

                <label class="radio">
                <input type="radio" name="status_kepemilikan" id="sewa" value="Sewa" {{ $data->status_kepemilikan == 'Sewa' ? 'checked' : '' }}>
                Sewa
                <span class="checkmark"></span>
                </label>
                </div>
