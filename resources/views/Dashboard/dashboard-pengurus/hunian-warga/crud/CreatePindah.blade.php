  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
        <div class="font">
        <span class="Data">KELUARGA PINDAH HUNIAN</span>
        <p class="nice">-</p>
        @include('komponen.pesan')
    </div>
        </div>
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/DataPindah') }}" method="POST">
            @csrf
                <div class="hunian">
                    <label for="warga_id" class="team">Kepala Keluarga</label>
                ...
                <div class="hunian">
                    <label for="nama" class="team">Hunian Saat Ini</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="hunian_asal" id="hunian_asal" value="{{ old("hunian_asal") }}">
                    </div>
                </div>

                <div class ="radio-group">
                <label class="radio">
                <input type="radio" name="jenis_pindah" id="pindah_dalam" value="Pindah Dalam Hunian">
                Pindah Dalam Lingkungan
                <span class="checkmark"></span>
                </label>

                <label class="radio">
                <input type="radio" name="jenis_pindah" id="pindah_keluar" value="Pindah Keluar Hunian">
                Pindah Luar Lingkungan
                <span class="checkmark"></span>
                </label>
                </div>
                ...
                <div class="hunian">
                    <div class="col-sm-10">
                        <div id="hunian_baru" style="display: none;">
                ...
                <div class="hunian">
                    <label for="nama" class="team">Tanggal Pindah</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" name="tanggal" id="tanggal" value="{{ old("tanggal") }}">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Alasan Pindah</label>
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" name="alasan" id="alasan" value="{{ old("alasan") }}"></textarea>
                    </div>
                </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.0/jquery.min.js"></script>
    ...
    {{-- <form action="{{ url('/dashboardPengurus/DataPindah') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="hunian_asal" id="hunian_asal" class="form-control">
        </div>
        ...
        <div class="mb-3 ">
            <button type="submit" class="btn btn-primary">Tambah Data Pindah</button>
        </div>
    </form>
    <!-- AKHIR FORM -->
</main>
