  ...
  <div class="main-konten">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/DataPindah/'.$data->id) }}" method="POST">
                ...
                @method('PUT')
            <div class="hunian">
                    <label for="judul" class="team">Kepala Keluarga</label>
                    <div class="col-sm-10">
                ...
                <div class="hunian">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="hunian_asal" id="hunian_asal" value="{{ $data->hunian_asal }}">
                    </div>
                </div>

                <div class="radio-group">
                    <label class="radio">
                        <input type="radio" name="jenis_pindah" id="pindah_dalam" value="Pindah Dalam Hunian" {{ $data->jenis_pindah === 'Pindah Dalam Hunian' ? 'checked' : '' }}>
                        Pindah Dalam Lingkungan
                        <span class="checkmark"></span>
                    </label>

                    <label class="radio">
                        <input type="radio" name="jenis_pindah" id="pindah_keluar" value="Pindah Keluar Hunian" {{ $data->jenis_pindah === 'Pindah Keluar Hunian' ? 'checked' : '' }}>
                ...
                <div class="hunian">
                    <label for="nama" class="team">Hunian Baru</label>
                    <div class="col-sm-10">
                ...
                <div class="hunian">
                    <label for="alasan" class="team">Alasan Pindah</label>
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" name="alasan" id="alasan" >{{ $data->alasan }}</textarea>
                    </div>
                </div>
