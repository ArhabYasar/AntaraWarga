...
.tableone  .form-control {
        ...
        .tableone .hunian .zul input[type="date"]::-webkit-datetime-edit {
          color : #333;
        }
...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="head">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/KepemilikanHunian') }}" method="post">
                @csrf
                <div class="hunian">
                ...
                <div class="hunian">
                    <label for="nama" class="team">Pemilik</label>
                    <div class="col-sm-10">
                ...
                <div class="hunian">
                    <label for="nama" class="team">Tanggal kepemilikan</label>
                    <div class="zul">
                        <input type="date" class="form-control" value="{{ old('tanggal_kepemilikan') }}" name='tanggal_kepemilikan' id="pengarang">
                    </div>
                </div>
