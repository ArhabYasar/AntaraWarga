...
<div class="container">
  ...
  <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 11:28</h1>
    ...
    <div class="head">
        ...
        <div class="tableone">
            <form action="{{ url('/dashboardPengurus/DataHunian') }}" method="post">
                @csrf
                <div class="hunian">
                    <label for="judul" class="team">Blok/No.rumah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old('alamat') }}" name="alamat" id="alamat" autocomplete="off">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Tipe Hunian/Ruko</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old('tipe') }}" name='tipe' id="tipe">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Luas Tanah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old('luas_tanah') }}" name='luas_tanah' id="luas_tanah">
                    </div>
                </div>
                <div class="hunian">
                    <label for="nama" class="team">Luas Bangunan</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ old('luas_bangunan') }}" name='luas_bangunan' id="luas_bangunan">
                    </div>
                </div>
                <div class="hunian">
                    <label for="status_kepemilikan" class="team">Status Kepemilikan</label>
                    <div class="col-sm-10">
                    </div>
                </div>
                ...
                <label class="radio">
                <input type="radio" name="status_kepemilikan" id="milik_sendiri" value="Milik Sendiri">
                Milik Sendiri
                <span class="checkmark"></span>
                </label>

                <label class="radio">
                <input type="radio" name="status_kepemilikan" id="sewa" value="Sewa">
                Sewa
                <span class="checkmark"></span>
                </label>
                </div>
