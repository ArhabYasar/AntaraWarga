    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA KELUARGA<a href="{{ url('/dashboardPengurus/DataKeluarga/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/DataKeluarga') }}" method="get">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($item->getHunian)
                            ...
                            <td>{{ $item->getHunian->status_kepemilikan }}</td>
                        @else
                            <td>-</td>
                            <td>-</td>
                        @endif
                        <td>
                            <a href='{{ route('showKeluarga', $item->id) }}' class="btn btn-warning btn-sm">Detail</a>
                            <a href='{{ url('/dashboardPengurus/DataKeluarga/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/DataKeluarga/nkk/'.$item->nkk) }}" method="POST">
                                @csrf
                                @method('DELETE')
