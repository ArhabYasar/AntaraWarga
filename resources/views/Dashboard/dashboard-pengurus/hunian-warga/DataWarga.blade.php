    ...
    <div class="main-konten">
        ...
        <div class="strip" id="liveTime"></div>
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA WARGA<a href="{{ url('/dashboardPengurus/DataWarga/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/DataWarga') }}" method="get">
                        ...
                        <button id="openModalBtn" class="btn btn-warning btn-sm">Detail</button>
                          <div id="myModal" class="modal">
                            <div class="modal-content">
                              ...
                              <p> NIK <span class="kick">:</span>{{ $item->nik }}<br>
                                    Nama Warga <span class="slow">:</span>{{ $item->nama }}<br>
                                    Tempat-Lahir<span class="denim">:</span>{{ $item->tempat_lahir }}<br>
                                    Tanggal-Lahir <span class="sid">:</span>{{ $item->tanggal_lahir }}<br>
                                    Pekerjaan <span class="sud">:</span>{{ $item->pekerjaan }}</p>
                            </div>
                          </div>
                            <a href='{{ url('/dashboardPengurus/DataWarga/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/DataWarga/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button class ="btn btn-danger btn-sm" type="submit" id="deleteButton" >Hapus</button>
                            </form>
          ...
          confirmDelete.addEventListener("click", () => {
              ...
              modal1.style.display = "none";
                     ...
                     {{-- <div class="my-3 p-3 bg-body rounded shadow-sm">
                             <!-- FORM PENCARIAN -->
                             <div class="pb-3">
                                <form class="d-flex" action="{{ url('/dashboardPengurus/DataWarga') }}" method="get">
                             ...
                             <!-- TOMBOL TAMBAH DATA -->
                            <a href="{{ url('/dashboardPengurus/DataWarga/create') }}">
                             ...
                             <table class="table table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='{{ url('/dashboardPengurus/DataWarga/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                                            <form onsubmit="return confirm('Apakah Yakin Anda Ingin Menghapus Data Ini?')" class="d-inline" action="{{ url('/dashboardPengurus/DataWarga/'.$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
