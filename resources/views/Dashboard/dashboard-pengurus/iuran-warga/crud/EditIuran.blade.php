  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">DATA IURAN</span>
    <p class="nice">-</p>
    </div>
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Iuran/'.$data->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="hunian">
                <input type="hidden" name="user_id" value="{{ auth()->id() }}">
                <label for="tipe" class="team">Tipe Iuran</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ $data->tipe }}" name="tipe" id="tipe" autocomplete="off">                </div>
            </div>
            <div class="hunian">
                <label for="nama" class="team">Nama Iuran</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ $data->nama }}" name="nama" id="nama" autocomplete="off">                </div>
            </div>
            <div class="hunian">
                <label for="nominal" class="team">Nominal</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" value="{{ $data->nominal }}" name="nominal" id="nominal" autocomplete="off">                </div>
            </div>
            <div class="hunian">
                    <label for="keterangan" class="team">Keterangan</label>
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" autocomplete="off" name='keterangan' id="keterangan">{{ $data->keterangan }}</textarea>
                    </div>
                </div>
                ...
                <div class="simpen">
                    ...
                    <div class="col-sm-10">
                        ...
                        <button type="button" class="shut" name="submit">Kembali</button>
                    </div>
                </div>
        </form>
        </div>
