  ...
  <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                      ...
                      <div class="head">
    <div class="font">
    <span class="Data">PENGINGAT PEMBAYARAN > ADD</span>
    <p class="nice">-</p>
    </div>

<div class="tableone">
    <form action="/dashboardPengurus/PengingatPembayaran/{{ $data->id }}" method="POST">
        @csrf
        @method('PUT')
            <div class="hunian">
            ...
            <div class="hunian">
                <label for="nama" class="team">Nama Warga</label>
                <div class="col-sm-10">
                    <select name="user_id" id="user_id" class="form-control h-100">
                        @foreach ($user as $userItem)
                            <option value="{{ $userItem->id }}" {{ $data->user_id == $userItem->id ? 'selected' : '' }}>
                                {{ $userItem->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="hunian">
                <label for="nama" class="team">Tanggal Jatuh Tempo</label>
                <div class="col-sm-10">
