...
<div class="tableone">
    <form action="/dashboardPengurus/TerimaIuran/{{ $data->id }}" method="POST">
        @csrf <!-- Tambahkan CSRF token untuk keamanan -->
        @method('PUT') <!-- Menentukan metode HTTP sebagai PUT untuk pembaruan -->
            <div class="hunian">
                ...
                <div class="col-sm-10">
                    <select name="iuran_id" id="iuran_id" class="form-control h-100">
                        @foreach ($iuran as $iuranItem)
                            <option value="{{ $iuranItem->id }}" {{ $data->iuran_id == $iuranItem->id ? 'selected' : '' }}>
                                {{ $iuranItem->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-10">
                    <select name="warga_id" id="warga_id" class="form-control h-100">
                        @foreach ($warga as $wargaItem)
                            <option value="{{ $wargaItem->id }}" {{ $data->warga_id == $wargaItem->id ? 'selected' : '' }}>
                                {{ $wargaItem->nama }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="hunian">
                <label for="tanggal" class="team">Tanggal</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" value="{{ $data->tanggal }}" name='tanggal' id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="nominal" class="team"> Nominal</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" value="{{ $data->nominal }}" name='nominal' id="nama">
                </div>
            </div>
            <div class="hunian">
                <label for="penerima" class="team">Kas Penerima</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$data->penerima}}" name='penerima' id="nama">
                </div>
            </div>
