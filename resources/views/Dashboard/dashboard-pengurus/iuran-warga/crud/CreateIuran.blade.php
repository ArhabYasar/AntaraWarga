...
<div class="container">
  ...
  <div class="main-konten">
    ...
    <div class="tableone">
        <form action="{{ url('/dashboardPengurus/Iuran') }}" method="post">
            @csrf
            <div class="hunian">
                <input type="hidden" name="user_id" value="{{ auth()->id() }}">
                <label for="judul" class="team">Tipe Iuran</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ old('tipe') }}" name='tipe' id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="judul" class="team">Nama Iuran</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ old('nama') }}" name='nama' id="nik">
                </div>
            </div>
            <div class="hunian">
                <label for="judul" class="team">Nominal</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ old('nominal') }}" name='nominal' id="nik">
                </div>
            </div>
            <div class="hunian">
                    <label for="nama" class="team">Keterangan</label>
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" name='keterangan' id="pengarang">{{ old('keterangan') }}</textarea>
                    </div>
                </div>
