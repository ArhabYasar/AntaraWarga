    ...
    <div class="main-konten">
        <div class="around">
          <h1 class="strip">senin 19 desember | 11:36</h1>
                ...
                <p class="Data">PENGINGAT PEMBAYARAN<a href="{{ url('/dashboardPengurus/PengingatPembayaran/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/PengingatPembayaran') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->tanggal }}</td>
                        <td>
                            <a href='{{ url('/dashboardPengurus/PengingatPembayaran/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/PengingatPembayaran/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
