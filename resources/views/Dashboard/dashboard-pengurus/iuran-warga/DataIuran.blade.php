    ...
    <div class="main-konten">
        <div class="around">
          ...
          <h1 class="kanan"><img src="{{ asset('img/383.png') }}" alt="" class="icon" i class="fas fa-angle-right dropdown"></i>
                ...
                <p class="Data">DATA IURAN<a href="{{ url('/dashboardPengurus/Iuran/create') }}" class="btn btn-primary">Tambah Data</a></p>
                <p class="nice">-</p>

                <div class="pencarian">
                    <form action="{{ url('/dashboardPengurus/Iuran') }}" method="get">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button id="openModalBtn" class="btn btn-warning btn-sm" data-bs-target="#myModal{{ $item->id }}">Detail</button>

                            <div id="myModal{{ $item->id }}" class="modal">
                              <div class="modal-content">
                                <b class="sow"> Detail Iuran </b>
                                <span class="close" id="closeModalBtn">&times;</span>
                                <p> Tipe Iuran <span class="kick">:</span> {{ $item->tipe }}<br>
                                    Nama Iuran <span class="slow">:</span>{{ $item->nama }}<br>
                                    Nominal    <span class="denim">:</span>{{ $item->nominal }}<br>
                                    Keterangan <span class="sid">:</span>{{ $item->keterangan }}</p>
                              </div>
                            </div>
                            <a href='{{ url('/dashboardPengurus/Iuran/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url('/dashboardPengurus/Iuran/'.$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
