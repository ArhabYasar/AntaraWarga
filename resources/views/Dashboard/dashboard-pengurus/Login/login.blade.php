        ...
        <section class="login d-flex">
            ...
            <div class="login-right w-50 h-100">
                <div class="row justify-content-center align-items-center h-100 m-0">
                    <div class="col-7 p-0">
                        <div class="header">
                            <h2 class="lgn text-center">LOGIN</h2>
                            @if (session('success'))
                            <div class="pt-3">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="login-form">
                                <div class="input-group mb-2">
                                    <input type="text" value="{{ old('username') }}" class="form-control username" name="username" placeholder="Username" required autocomplete="off">
                                </div>
                                <div class="input-group mb-2">
                                    <input type="password" class="form-control username" name="password" placeholder="Password" required>
                                </div>
                                <button type="submit" class="btn btn-primary rounded btnlgn">LOGIN</button>
                                <a href="/forgot-password" class="text-center">FORGET PASSWORD</a>
                                <hr>
                                <a href="/register" class="text-center">
                                    <button type="button" class="btn btn-success btnregister" >REGISTRATION</button>
                                </a>
                            </div>
                        </form>
                    </div>
